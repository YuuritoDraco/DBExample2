...
public class AndroidDatabaseManager extends Activity implements OnItemClickListener
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        try
        {
            ...
            //the menu_main linear layout to which all tables spinners etc will be added.In this activity every element is created dynamically  to avoid using xml file
            ...
            //all required layouts are created dynamically and added to the menu_main scrollview
            ...
            //the menu_main table layout where the content of the sql tables will be displayed when user selects a table
                                            ...
                                            runOnUiThread(new Runnable()
                                            {
                                                ...
                                                public void run()
                                                {
                                                    if (!isFinishing())
                                                    {
                                                        ...
                                                        new AlertDialog.Builder(AndroidDatabaseManager.this).setTitle("Are you sure ?").setMessage("Pressing yes will remove " + indexInfo.table_name + " table from database").setPositiveButton("yes", new DialogInterface.OnClickListener()
                                                        {
                                            ...
                                            runOnUiThread(new Runnable()
                                            {
                                                ...
                                                public void run()
                                                {
                                                    if (!isFinishing())
                                                    {
                                                        ...
                                                        new AlertDialog.Builder(AndroidDatabaseManager.this).setTitle("Are you sure?").setMessage("Clicking on yes will delete all the contents of " + indexInfo.table_name + " table from database").setPositiveButton("yes", new DialogInterface.OnClickListener()
                                                        {
                                        ...
                                        if (spinnertable.getSelectedItem().toString().equals("Add row to this table"))
                                        {
                                            ...
                                            runOnUiThread(new Runnable()
                                            {
                                                ...
                                                public void run()
                                                {
                                                    if (!isFinishing())
                                                    {
                                                        new AlertDialog.Builder(AndroidDatabaseManager.this).setTitle("values").setCancelable(false).setView(addrowsv).setPositiveButton("Add", new DialogInterface.OnClickListener()
                                                        {
